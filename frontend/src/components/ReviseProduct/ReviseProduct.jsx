...
class ReviseProduct extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id: '',
        ...
        return (
            <div className="add-product-page" style={{
                ...
                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6" style={{
                    ...
                    <h3 className="title" style={{ position: 'relative', justifyContent: 'center' }}>Sửa sản phẩm</h3>
                    <form onSubmit={this.onSave}>
                        ...
                        <div className="number">
                            <label>
                                <input type="number" name="txtCount" value={txtCount} onChange={this.onChange} />
                            </label>
                        </div>
